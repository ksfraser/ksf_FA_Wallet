 ...
 * 
 * @package KsfFA_ksf_FA_Wallet
 * @version 2.4.3
 */

define('SS_ksf_FA_Wallet', 141 << 8);

class hooks_ksf_FA_Wallet extends hooks {
    var $module_name = 'ksf_FA_Wallet';
    var $version = '1.0.0';
    ...
    function install_access() {
        $security_sections[SS_ksf_FA_Wallet] = _("");
        $security_areas['SA_ksf_FA_WalletVIEW'] = array(
            SS_ksf_FA_Wallet | 1, 
            _("View ")
        );
        $security_areas['SA_ksf_FA_WalletMANAGE'] = array(
            SS_ksf_FA_Wallet | 2, 
            _("Manage ")
        );
